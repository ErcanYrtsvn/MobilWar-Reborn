...
function olusturBarakaPaneli() {
  ...
  ustPanel.id = "kaynakDurumu";
  ustPanel.style.fontWeight = "bold";
  ustPanel.style.fontSize = "1rem";
  ustPanel.style.marginBottom = "1rem";
  ustPanel.style.background = "#3d2a12";
  ustPanel.style.padding = "0.5rem";
  ustPanel.style.borderRadius = "6px";
  ustPanel.style.textAlign = "center";
  panel.parentNode.insertBefore(ustPanel, panel);
