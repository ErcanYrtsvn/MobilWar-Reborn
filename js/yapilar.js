...
// Tapınak arayüzünü Yapılar sekmesine manuel olarak ekliyoruz
const tapinakPanel = document.createElement("div");
tapinakPanel.innerHTML = tapinakArayuzOlustur();
document.getElementById("structures").appendChild(tapinakPanel);
