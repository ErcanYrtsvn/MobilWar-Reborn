...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function guncelleBirlikListesi() {
    ...
    Object.keys(birlikGucu).forEach(birlik => {
      ...
      div.innerHTML = `
        <span style="min-width: 160px; font-weight: bold;">${birlikIkonlari[birlik]} ${birlik}</span>
        <span style="width: 80px;">${adet} adet</span>
        <input type="number" min="1" max="${adet}" placeholder="Adet" style="width: 80px; padding: 3px;">
...
// Eğer magara.js yüklüyse paneli güncelle
if (typeof guncelleMagaraPanel === "function") {
  guncelleMagaraPanel();
}
