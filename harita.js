...
// === MobilWar Modal + Sefer Patch (inline, append-only) ===
(function(){
  ...
  .mw-modal-header button{ background:transparent; border:0; color:#ffe9b0; font-size:48px; cursor:pointer; }
  .mw-modal-body{ padding:22px 24px; font-size:28px; line-height:1.6; }
  .mw-row{ margin:6px 0; }
  .mw-modal-actions{ display:flex; gap:10px; padding:22px 24px; border-top:1px solid rgba(212,177,95,.35); }
  .mw-modal-actions button{
    flex:1; padding:18px 22px; font-size:28px; font-weight:800; border:0; border-radius:10px; cursor:pointer;
  }
